...
import HeadingNav from './CataLoguesHeadingNav/CataLoguesHeadingNav';
import "./MySharedCatalogues.css";
import UserProductCard from './CatalogueProductCard/CatalogueProductCard';
const MySharedCatalogues = () => {
const cardData = [
    {
    ...
    return (
        <div className='container-fluid mt-5 p-o ff'>
            <HeadingNav title ={"My Shared Catalogues"}/>
            <UserProductCard cardData={cardData} />
        </div>
    )
}

export default MySharedCatalogues;