      ...
      <div className="row" style={{display:"flex",justifyContent:"space-around"}} id="nm" >
        <div className="col-7" id="col7">
          ...
          <div className="container-fluid px-0" style={{display:"flex",flexDirection:"column", gap:"1rem"}} >
            ...
            <h6 style={{color:"#344054", fontSize:"18px", marginBottom:"0px",fontWeight:"700"}} >Address</h6>
            <div className="container-fluid text-end" style={{display:"flex",justifyContent:"end",alignItems:"center"}}>
                   <div className="d-flex align-items-center">
                    <span style={{color:"#344054", fontSize:"18px", fontWeight:"700", marginRight:"10px"}}>Save Address As</span>
                    <div style={{borderTopLeftRadius:"8rem", padding:"4px 0px",paddingLeft:"18px",fontSize:".8rem",borderBottomLeftRadius:"8rem",border:"1px solid #EAECF0",backgroundColor:"#164C96",color:"white"}}>Home</div>
                    <div style={{borderTopRightRadius:"8rem",fontSize:".8rem", padding:"4px 0px",paddingRight:"18px",borderBottomRightRadius:"8rem",border:"1px solid #EAECF0",backgroundColor:"transparent"}}>Work</div>
                   </div>
                </div>
            </div>

            <div className="container-fluid p-0 rounded-2" style={{border: "1px solid #D0D5DD"}}>
                <input className="rounded-2 px-3" placeholder="Enter Address (House No. Building, Street, Area) *" style={{width:"100%",height:"2.5rem",border:"none",outline:"none"}} type="text" />
            </div>
            <div className="row">
                <div className="col-6">
                    <div className="container-fluid p-0">
                ...
                <div className="container-fluid gap-2 " style={{display:"flex",fontSize:".8rem",alignItems:"center"}}>
                    < input type="checkbox" />Save address as default address
                </div>
            </div>
